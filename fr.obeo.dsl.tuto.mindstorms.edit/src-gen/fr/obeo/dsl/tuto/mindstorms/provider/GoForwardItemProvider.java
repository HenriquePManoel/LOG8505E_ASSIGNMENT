...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.tuto.mindstorms.GoForward} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GoForwardItemProvider extends ActionItemProvider {
	...
	protected void addCmPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GoForward_cm_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_GoForward_cm_feature",
								"_UI_GoForward_type"),
						MindstormsPackage.Literals.GO_FORWARD__CM, true, false, false,
	...
	public String getText(Object object) {
		GoForward goForward = (GoForward) object;
		return getString("_UI_GoForward_type") + " " + goForward.getCm();
	}
