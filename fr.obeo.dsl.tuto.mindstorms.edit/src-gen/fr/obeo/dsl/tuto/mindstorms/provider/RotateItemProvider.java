...
public class RotateItemProvider extends ActionItemProvider {
	...
	protected void addDegreesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Rotate_degrees_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Rotate_degrees_feature",
								"_UI_Rotate_type"),
						MindstormsPackage.Literals.ROTATE__DEGREES, true, false, false,
	...
	protected void addRandomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Rotate_random_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Rotate_random_feature", "_UI_Rotate_type"),
						MindstormsPackage.Literals.ROTATE__RANDOM, true, false, false,
