 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.tuto.mindstorms.impl.ChoreographyImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.obeo.dsl.tuto.mindstorms.impl.ChoreographyImpl#getInstructions <em>Instructions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChoreographyImpl extends InstructionImpl implements Choreography {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindstormsPackage.CHOREOGRAPHY__NAME, oldName, name));
	}
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					MindstormsPackage.CHOREOGRAPHY__INSTRUCTIONS);
		}
		return instructions;
	}
