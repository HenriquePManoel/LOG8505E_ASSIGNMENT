 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.tuto.mindstorms.impl.RotateImpl#getDegrees <em>Degrees</em>}</li>
 *   <li>{@link fr.obeo.dsl.tuto.mindstorms.impl.RotateImpl#isRandom <em>Random</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RotateImpl extends ActionImpl implements Rotate {
	...
	public void setDegrees(int newDegrees) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindstormsPackage.ROTATE__DEGREES, oldDegrees,
					degrees));
	}
