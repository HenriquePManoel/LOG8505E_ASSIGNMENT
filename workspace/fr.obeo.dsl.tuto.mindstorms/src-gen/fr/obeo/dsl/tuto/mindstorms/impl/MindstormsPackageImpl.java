...
public class MindstormsPackageImpl extends EPackageImpl implements MindstormsPackage {
	...
	public static MindstormsPackage init() {
		if (isInited)
			return (MindstormsPackage) EPackage.Registry.INSTANCE.getEPackage(MindstormsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMindstormsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MindstormsPackageImpl theMindstormsPackage = registeredMindstormsPackage instanceof MindstormsPackageImpl
				? (MindstormsPackageImpl) registeredMindstormsPackage
				: new MindstormsPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEAttribute(getChoreography_Name(), ecorePackage.getEString(), "name", null, 0, 1, Choreography.class,
		...
		initEClass(goForwardEClass, GoForward.class, "GoForward", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGoForward_Cm(), ecorePackage.getEInt(), "cm", null, 0, 1, GoForward.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(rotateEClass, Rotate.class, "Rotate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRotate_Degrees(), ecorePackage.getEInt(), "degrees", null, 0, 1, Rotate.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRotate_Random(), ecorePackage.getEBoolean(), "random", "false", 0, 1, Rotate.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
